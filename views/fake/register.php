        ...
        <div class="col-xs-8 col-md-6">
            <div class="raform">
                <form action="" method="post">
                    ...
                    <input id="name" type="text" name="username" placeholder="придумайте ник..." onblur="check_login(this); return false;" />
                    <label for="password">Пароль</label>
                    <input id="password" type="password" name="password" placeholder="придумайте пароль..." onblur="check_password(this)"/>
                    <label for="email">Емейл</label>
                    <input id="email" type="text" name="email" placeholder="введите емейл..." onblur="check_mail(this)"/>
                    <button id="register" type="submit" >Зерегистрироваться</button>
                </form>
            </div>
        </div>
     <div class="col-xs-2 col-md-3"></div>
